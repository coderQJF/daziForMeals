...
import { planMeals, type PlanDish } from '@/mocks/plan'
  ...
  <view class="plan-page">
    ...
    <view class="header">
      <view class="header__copy">
        <text class="header__title">饮食计划</text>
        <text class="header__subtitle">科学搭配每一餐，助力骨骼修复</text>
      </view>
      <button class="calendar-button" aria-label="查看当月日历" @click="openCalendar">
        <image class="calendar-button__icon" src="/static/images/plan/calendar.png" mode="aspectFit" />
      </button>
    </view>
...
.plan-page {
  ...
  min-height: 100vh;
  overflow-x: hidden;
  padding: calc(var(--status-bar-height) + 26rpx) 30rpx calc(env(safe-area-inset-bottom) + 180rpx);
  background: #fdf9f4;
...
/* #ifdef MP-WEIXIN */
.calendar-button { margin-right: 178rpx; }
/* #endif */
